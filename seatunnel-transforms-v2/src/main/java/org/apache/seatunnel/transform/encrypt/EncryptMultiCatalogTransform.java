...
/**
 * Encrypt transform 的多表包装（模式对齐 Replace）。
 */
public class EncryptMultiCatalogTransform extends AbstractMultiCatalogMapTransform {

    public EncryptMultiCatalogTransform(
