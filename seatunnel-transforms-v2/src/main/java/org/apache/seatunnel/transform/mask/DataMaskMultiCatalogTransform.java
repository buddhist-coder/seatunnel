...
/**
 * DataMask transform 的多表包装（模式对齐 Replace）。
 */
public class DataMaskMultiCatalogTransform extends AbstractMultiCatalogMapTransform {

    public DataMaskMultiCatalogTransform(
    ...
    protected SeaTunnelTransform<SeaTunnelRow> buildTransform(
        ...
        return new DataMaskTransform(config, inputCatalogTable);
    }
